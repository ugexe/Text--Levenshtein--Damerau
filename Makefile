...
MAN3PODS = lib/Text/Levenshtein/Damerau.pm \
	lib/Text/Levenshtein/Damerau/PP.pm
...
PM_TO_BLIB = lib/Text/Levenshtein/Damerau/PP.pm \
...
DISTVNAME = Text-Levenshtein-Damerau-0.35
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Text/Levenshtein/Damerau/PP.pm $(INST_MAN3DIR)/Text::Levenshtein::Damerau::PP.$(MAN3EXT) \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Damerau Levenshtein edit distance.'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Text-Levenshtein-Damerau' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'version: 0.35' >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) '{' > META_new.json
	$(NOECHO) $(ECHO) '   "abstract" : "Damerau Levenshtein edit distance.",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Text-Levenshtein-Damerau",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "web" : "https://rt.cpan.org/Public/Dist/Display.html?Name=Text-Levenshtein-Damerau"' >> META_new.json
	$(NOECHO) $(ECHO) '      },' >> META_new.json
	$(NOECHO) $(ECHO) '      "repository" : {' >> META_new.json
	$(NOECHO) $(ECHO) '         "url" : "https://github.com/ugexe/Text--Levenshtein--Damerau"' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "version" : "0.35"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.35">' > $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Text/Levenshtein/Damerau/PP.pm blib/lib/Text/Levenshtein/Damerau/PP.pm \
